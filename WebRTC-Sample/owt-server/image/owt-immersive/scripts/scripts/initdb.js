...
var sampleServiceFile = path.resolve(dirName, script);
if(script === '../scripts/updateRoom360.js'){
   sampleServiceFile = path.resolve(dirName, '../scripts/updateRoom360.js');
}
else if(script === '../scripts/addRtsp.js'){
    sampleServiceFile = path.resolve(dirName, '../scripts/addRtsp.js');
}
else if(script === '../scripts/clearRtsp.js'){
   sampleServiceFile = path.resolve(dirName, '../scripts/clearRtsp.js');
}
